...
public class WeakBaseLineCrossStrategy implements StrategyBuilder {

    private final String symbol;

    public WeakBaseLineCrossStrategy(String symbol) {
        this.symbol = symbol;
    }
    ...
    public StrategyWithIndicators getLongStrategy(BarSeries series) {
      ...
      return new StrategyWithIndicators("WeakBaseLineCrossStrategy-LONG", symbol, enterRule, exitRule, cpi, kinjun, spanA, spanB);
    }
    ...
    public StrategyWithIndicators getShortStrategy(BarSeries series) {
      ...
      return new StrategyWithIndicators("WeakBaseLineCrossStrategy-SHORT", symbol, enterRule, exitRule, cpi, kinjun, spanA, spanB);
    }
