...
public class StrongTenkanKinjunCrossStrategy implements StrategyBuilder {
    ...
    public StrategyWithIndicators getLongStrategy(BarSeries series) {
        ...
        return new StrategyWithIndicators("StrongTenkanKinjunCross-LONG", symbol, enterRule, exitRule, cpi, tenkan, kinjun, chikouTwentySixPeriodsAgo, spanA, spanB, priceTwentySixPeriodsAgo);
    }
    ...
    public StrategyWithIndicators getShortStrategy(BarSeries series) {
        ...
        return new StrategyWithIndicators("StrongTenkanKinjunCross-SHORT", symbol, enterRule, exitRule, cpi, tenkan, kinjun, chikouTwentySixPeriodsAgo, spanA, spanB, priceTwentySixPeriodsAgo);
    }
}
