...
public class SimpleLongSarEma200Strategy implements StrategyBuilder {
    ...
    public StrategyWithIndicators getLongStrategy(BarSeries series) {
        ...
        return new StrategyWithIndicators("SIMPLE-SAR+EMA200-LONG", symbol, enterRule, exitRule, parabolicSarIndicator, cpi,
                ema200);
    }
    ...
    public StrategyWithIndicators getShortStrategy(BarSeries series) {
        ...
        return new StrategyWithIndicators("SIMPLE-SAR+EMA200-SHORT", symbol, enterRule, exitRule, parabolicSarIndicator, cpi,
                ema200); // ONLY SHORT
    }
