...
public class ScalpingForBitcoin implements StrategyBuilder {
    ...
    public StrategyWithIndicators getLongStrategy(BarSeries series) {
        ...
        return new StrategyWithIndicators("BITCOIN-SAR+EMA5+EMA8+EMA13-LONG", symbol, enterRule, exitRule, parabolicSarIndicator, cpi,
                ema5, ema8, ema13);
    }
    ...
    public StrategyWithIndicators getShortStrategy(BarSeries series) {
        ...
        Rule exitRule = new StopLossRule(cpi, 0.5).or(new StopGainRule(cpi, 2));
        return new StrategyWithIndicators("BITCOIN-SAR+EMA5+EMA8+EMA13-SHORT", symbol, enterRule, exitRule, parabolicSarIndicator, cpi,
                ema5, ema8, ema13);
    }
