...
public class SimpleSarEma100Ema150Ema200Strategy implements StrategyBuilder {
    ...
    public StrategyWithIndicators getLongStrategy(BarSeries series) {
        ...
        return new StrategyWithIndicators("SIMPLE-SAR+EMA100+EMA150++EMA200-LONG", symbol, enterRule, exitRule, parabolicSarIndicator, cpi,
                ema200);
    }
    ...
    public StrategyWithIndicators getShortStrategy(BarSeries series) {
        ...
        return new StrategyWithIndicators("SIMPLE-SAR+EMA100+EMA150+EMA200-SHORT", symbol, enterRule, exitRule, parabolicSarIndicator, cpi,
                ema200);
    }
