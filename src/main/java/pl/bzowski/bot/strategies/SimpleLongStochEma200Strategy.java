...
public class SimpleLongStochEma200Strategy implements StrategyBuilder {
    ...
    public StrategyWithIndicators getLongStrategy(BarSeries series) {
        ...
        return new StrategyWithIndicators("SIMPLE-STOCH+EMA200-LONG", symbol, enterRule, exitRule, ema200, cpi);
    }
    ...
    public StrategyWithIndicators getShortStrategy(BarSeries series) {
        ...
        Rule exitRule = new UnderIndicatorRule(kIndicator, 20);
        return new StrategyWithIndicators("SIMPLE-STOCH+EMA200-SHORT", symbol, enterRule, exitRule, ema200, cpi); // ONLY SHORT
    }
